...
$app->get('/profile/get_notification_center_content', 'main\controllers\profile::get_notification_center_content');
...
$app->get('/user/get_user_letter', 'main\controllers\users::get_user_letter');
$app->get('/user/logs', 'main\controllers\users::logs');
$app->get('/user/get_dialog_clear_logs', 'main\controllers\users::get_dialog_clear_logs');
$app->get('/user/clear_logs', 'main\controllers\users::clear_logs');
$app->get('/user/get_user_content', 'main\controllers\users::get_user_content');
$app->get('/user/get_user_information', 'main\controllers\users::get_user_information');
$app->get('/user/get_dialog_edit_fio', 'main\controllers\users::get_dialog_edit_fio');
$app->get('/user/update_fio', 'main\controllers\users::update_fio');
$app->get('/user/get_dialog_edit_login', 'main\controllers\users::get_dialog_edit_login');
$app->get('/user/update_login', 'main\controllers\users::update_login');
$app->get('/user/get_dialog_edit_user_status', 'main\controllers\users::get_dialog_edit_user_status');
$app->get('/user/update_user_status', 'main\controllers\users::update_user_status');
$app->get('/user/get_dialog_edit_password', 'main\controllers\users::get_dialog_edit_password');
$app->get('/user/update_password', 'main\controllers\users::update_password');
$app->get('/user/get_dialog_create_user', 'main\controllers\users::get_dialog_create_user');
$app->get('/user/create_user', 'main\controllers\users::create_user');
$app->get('/user/get_group_letters', 'main\controllers\users::get_group_letters');
$app->get('/user/get_user_letters', 'main\controllers\users::get_user_letters');
$app->get('/user/get_group_letter', 'main\controllers\users::get_group_letter');
$app->get('/user/get_group_content', 'main\controllers\users::get_group_content');
$app->get('/user/get_group_users', 'main\controllers\users::get_group_users');
$app->get('/user/get_dialog_edit_group_name', 'main\controllers\users::get_dialog_edit_group_name');
$app->get('/user/update_group_name', 'main\controllers\users::update_group_name');
$app->get('/user/get_group_profile', 'main\controllers\users::get_group_profile');
$app->get('/user/get_dialog_add_user', 'main\controllers\users::get_dialog_add_user');
$app->get('/user/add_user', 'main\controllers\users::add_user');
$app->get('/user/get_dialog_exclude_user', 'main\controllers\users::get_dialog_exclude_user');
$app->get('/user/exclude_user', 'main\controllers\users::exclude_user');
$app->get('/user/get_dialog_create_group', 'main\controllers\users::get_dialog_create_group');
$app->get('/user/create_group', 'main\controllers\users::create_group');
$app->get('/user/get_user_profiles', 'main\controllers\users::get_user_profiles');
$app->get('/user/get_profile_content', 'main\controllers\users::get_profile_content');
$app->get('/user/update_rule', 'main\controllers\users::update_rule');
$app->get('/user/get_dialog_delete_profile', 'main\controllers\users::get_dialog_delete_profile');
$app->get('/user/delete_profile', 'main\controllers\users::delete_profile');
$app->get('/user/get_dialog_add_profile', 'main\controllers\users::get_dialog_add_profile');
$app->get('/user/add_profile', 'main\controllers\users::add_profile');
$app->get('/user/get_restriction_content', 'main\controllers\users::get_restriction_content');
$app->get('/user/update_restriction', 'main\controllers\users::update_restriction');
...
$app->post('/metrics/remove_metrics', 'main\controllers\metrics::remove_metrics');
...
$app->get('/export/get_dialog_export_numbers', 'main\controllers\export::get_dialog_export_numbers');
$app->get('/export/export_numbers', 'main\controllers\export::export_numbers');
...
$app->get('/query/get_search_result', 'main\controllers\queries::get_search_result');
$app->get('/query/get_query_content', 'main\controllers\queries::get_query_content');
$app->get('/query/get_query_title', 'main\controllers\queries::get_query_title');
...
$app->get('/query/get_query_numbers', 'main\controllers\queries::get_query_numbers');
$app->get('/query/get_query_users', 'main\controllers\queries::get_query_users');
$app->get('/query/get_query_works', 'main\controllers\queries::get_query_works');
$app->get('/query/get_query_comments', 'main\controllers\queries::get_query_comments');
$app->get('/query/get_dialog_edit_payment_status', 'main\controllers\queries::get_dialog_edit_payment_status');
$app->get('/query/update_payment_status', 'main\controllers\queries::update_payment_status');
$app->get('/query/get_dialog_edit_work_type', 'main\controllers\queries::get_dialog_edit_work_type');
$app->get('/query/update_work_type', 'main\controllers\queries::update_work_type');
$app->get('/query/get_dialog_edit_warning_status', 'main\controllers\queries::get_dialog_edit_warning_status');
$app->get('/query/update_warning_status', 'main\controllers\queries::update_warning_status');
$app->get('/query/get_dialog_edit_description', 'main\controllers\queries::get_dialog_edit_description');
$app->get('/query/update_description', 'main\controllers\queries::update_description');
$app->get('/query/get_dialog_edit_reason', 'main\controllers\queries::get_dialog_edit_reason');
$app->get('/query/update_reason', 'main\controllers\queries::update_reason');
$app->get('/query/get_dialog_edit_contact_information', 'main\controllers\queries::get_dialog_edit_contact_information');
$app->get('/query/update_contact_information', 'main\controllers\queries::update_contact_information');
$app->get('/query/get_dialog_reopen_query', 'main\controllers\queries::get_dialog_reopen_query');
$app->get('/query/reopen_query', 'main\controllers\queries::reopen_query');
$app->get('/query/get_dialog_reclose_query', 'main\controllers\queries::get_dialog_reclose_query');
$app->get('/query/reclose_query', 'main\controllers\queries::reclose_query');
$app->get('/query/get_dialog_close_query', 'main\controllers\queries::get_dialog_close_query');
$app->get('/query/close_query', 'main\controllers\queries::close_query');
$app->get('/query/get_dialog_to_working_query', 'main\controllers\queries::get_dialog_to_working_query');
$app->get('/query/to_working_query', 'main\controllers\queries::to_working_query');
$app->get('/query/get_dialog_add_user', 'main\controllers\queries::get_dialog_add_user');
$app->get('/query/get_user_options', 'main\controllers\queries::get_user_options');
$app->get('/query/add_user', 'main\controllers\queries::add_user');
$app->get('/query/get_dialog_remove_user', 'main\controllers\queries::get_dialog_remove_user');
$app->get('/query/remove_user', 'main\controllers\queries::remove_user');
$app->get('/query/get_dialog_add_comment', 'main\controllers\queries::get_dialog_add_comment');
$app->get('/query/add_comment', 'main\controllers\queries::add_comment');
$app->get('/query/get_dialog_add_work', 'main\controllers\queries::get_dialog_add_work');
$app->get('/query/add_work', 'main\controllers\queries::add_work');
$app->get('/query/get_dialog_remove_work', 'main\controllers\queries::get_dialog_remove_work');
...
$app->get('/query/set_department', 'main\controllers\queries::set_department');
...
$app->get('/query/get_dialog_change_initiator', 'main\controllers\queries::get_dialog_change_initiator');
...
$app->get('/query/change_initiator', 'main\controllers\queries::change_initiator');
$app->get('/query/get_dialog_create_query', 'main\controllers\queries::get_dialog_create_query');
$app->get('/query/get_dialog_initiator', 'main\controllers\queries::get_dialog_initiator');
...
$app->get('/report/get_query_reports', 'main\controllers\reports::get_query_reports');
$app->get('/report/clear_filter_query', 'main\controllers\reports::clear_filter_query');
$app->get('/report/set_time_begin', 'main\controllers\reports::set_time_begin');
$app->get('/report/set_time_end', 'main\controllers\reports::set_time_end');
$app->get('/report/set_filter_query_status', 'main\controllers\reports::set_filter_query_status');
$app->get('/report/set_filter_query_department', 'main\controllers\reports::set_filter_query_department');
$app->get('/report/set_filter_query_worktype', 'main\controllers\reports::set_filter_query_worktype');
$app->get('/report/set_filter_query_street', 'main\controllers\reports::set_filter_query_street');
$app->get('/report/set_filter_query_house', 'main\controllers\reports::set_filter_query_house');
$app->get('/report/report_query_one', 'main\controllers\reports::report_query_one');
$app->get('/report/report_query_one_xls', 'main\controllers\reports::report_query_one_xls');

# tasks
$app->get('/task/', 'main\controllers\task::default_page');
$app->get('/task/show_active_tasks', 'main\controllers\task::show_active_tasks');
$app->get('/task/show_finished_tasks', 'main\controllers\task::show_finished_tasks');
$app->get('/task/get_task_content', 'main\controllers\task::get_task_content');
$app->get('/task/send_task_comment', 'main\controllers\task::send_task_comment');
$app->get('/task/edit_task_content', 'main\controllers\task::edit_task_content');
$app->get('/task/save_task_content', 'main\controllers\task::save_task_content');
$app->get('/task/get_dialog_create_task', 'main\controllers\task::get_dialog_create_task');
