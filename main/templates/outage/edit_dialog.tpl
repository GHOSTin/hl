...
<div class="row">
  <div class="form-group col-md-6">
    ...
    <input type="text" class="form-control dialog-begin" value="{{ outage.get_begin()|date("d.m.Y") }}">
  </div>
  <div class="form-group col-md-6">
    <label>Планируемая дата</label>
    <input type="text" class="form-control dialog-target" value="{{ outage.get_target()|date("d.m.Y") }}">
  </div>
</div>
<div class="row">
...
<div class="form-group">
  ...
  <textarea class="form-control dialog-description" rows="3" autofocus required>{{ outage.get_description() }}</textarea>
</div>
{% endblock dialog %}
