<div class="workgroup-content">
  <a class="btn btn-sm btn-primary m-t-xs m-b-xs get_dialog_rename_workgroup"><i class="fa fa-pencil-square-o"></i></a>
    ...
    <div class="tab-content">
      <div role="tabpanel" class="tab-pane active" id="works">
        <div class="panel-body">
          <button type="button" class="btn btn-primary btn-xs m-b-sm get_dialog_add_work"><i class="fa fa-plus"></i></button>
      ...
      <div role="tabpanel" class="tab-pane" id="events">
        <div class="panel-body">
          <button class="btn btn-primary btn-xs m-b-sm get_dialog_add_event"><i class="fa fa-plus"></i></button>
          <div class="no-padding">
      ...
      <div role="tabpanel" class="tab-pane" id="phrases">
        <div class="panel-body">
          <button class="btn btn-primary btn-xs m-b-sm get_dialog_add_phrase"><i class="fa fa-plus"></i></button>
          <div class="no-padding">
